...
const buttonVariants = cva(
  cn(
    "font-mono inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-semibold transition-all",
    ...
    "dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive duration-200 transition-all",
  ),
  {
    variants: {
      variant: {
